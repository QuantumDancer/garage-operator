...
*/}}
{{- define "garage-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "garage-operator.resourceName" -}}
{{- $fullname := include "garage-operator.fullname" .context }}
{{- $suffix := .suffix }}
...
{{- else }}
{{- include "garage-operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
